...
<html lang="en">
  <head>
    ...
    <title>GMS | Complaint History</title>
                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr style="text-align: center">
                                  ...
                                  <th style="text-align: center">Reg Date & Time</th>
...
while($row=mysqli_fetch_array($query))
{
  ?>
                              <tr>
                                  ...
                                  <td align="center"><?php $status=$row['status'];
                                   ...
                                   <?php } ?>
                                   <td align="center"><a href="complaint-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">
