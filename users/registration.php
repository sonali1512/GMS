...
<html lang="en">
  <head>
    ...
    <title>GMS | User Registration</title>
  ...
  <body>
	...
	<hr />
		      <form class="form-login" method="post">
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-info btn-lg btn-block"  type="submit" name="submit" id="submit"><i class="fa fa-user"></i> Register</button>
		            <hr>
    ...
    <script>
        $.backstretch("assets/img/login-bgimg.jpg", {speed: 500});
    </script>
